...
__root CFG_HDR cfghdr_link_0 = {CFG_CHECKBOX, "Enable", 0, 2};
__root int CFG_LINK_ENABLE = 1;
...
__root CFG_HDR cfghdr_link_4 = {CFG_UINT, "Vertical indent of next link", 0, 100};
__root int CFG_LINK_V_INDENT_NEXT_LINK = 14;
